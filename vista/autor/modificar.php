...
<body>
    ...
    <div class="container">
        ...
        <?php
            ...
            $stmt = $conexion->prepare("SELECT * FROM autores WHERE id_autor = :id_autor");
            $stmt->bindValue(":id_autor", $id, PDO::PARAM_INT);
            $stmt->execute();
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <button class="btn btn-success" onclick="ModificarRegistro(<?php echo $registro->id_autor; ?>);" name="modificar" id="modificar" type="button">Modificar</button>
